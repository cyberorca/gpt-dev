<script>
    ...
    parent.document.querySelector("body").insertAdjacentElement("beforeend", _styleElement); /** CSS */
    parent.document.querySelector("body").insertAdjacentElement("beforeend", _templateElement); /**  TEMPLATE */
    parent.document.querySelector("body").insertAdjacentElement("beforeend", _scriptElement); /** SCRIPT */
